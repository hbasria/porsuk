...
class IsA(models.Model): # Source
    name = models.CharField(_('IsA'), max_length=50)
...
class Archive(models.Model):
    ...
    type = models.CharField(_('Type'), max_length=35, blank=True, null=True)
    sha1sum = models.CharField(_('sha1sum'), max_length=200)
    target = models.CharField(_('Target'), max_length=200, blank=True, null=True)
    ...
    class Admin:
        list_display = ('type', 'uri', 'sha1sum', 'target')
...
class Patch(models.Model): # Source
    ...
    source = models.ForeignKey('Source', related_name="patches")
...
class Component(models.Model):
    ...
    localname = models.CharField(_('Local Name'), max_length=200)
...
class Source(models.Model):
    slug = models.SlugField(_('Source Slug'), max_length=150, unique=True)
    ...
    isa = models.ManyToManyField(IsA, verbose_name=_('Is A'), null=True, blank=True)
    part_of = models.CharField(_('Partof'), max_length=100, blank=True, null=True)
    summary = models.CharField(_('Summary'), max_length=600, blank=True, null=True)
    description = models.CharField(_('Description'), max_length=1500, blank=True, null=True)
    icon = models.CharField(_('Icon'), max_length=100, blank=True, null=True)
    archives = models.ManyToManyField(Archive, verbose_name=_('Archives'))
    ...
    version = models.CharField(_('Version'), max_length=40, null=True, blank=True)
    release = models.CharField(_('Release'), max_length=40, null=True, blank=True)
    ...
    updates = models.ManyToManyField(Update, verbose_name=_('Update'), null=True, blank=True)

    ### İstatistik ###
    created_at = models.DateTimeField(_('First Release Date'), null=True, blank=True)
    updated_at = models.DateTimeField(_('Last Update'), null=True, blank=True)
    build_script_size = models.IntegerField(_('Build Script Size'), null=True, blank=True)
    spec_script_size = models.IntegerField(_('Spec Script Size'), null=True, blank=True)
    update_count = models.IntegerField(_('Update Count'), null=True, blank=True)
    patch_count = models.IntegerField(_('Patch Count'), null=True, blank=True)
...
class Package(models.Model):
    ...
    name = models.CharField(_('Name'), max_length=80)
    slug = models.SlugField(_('Package Slug'), max_length=200, unique=True)
